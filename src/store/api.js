...
export default {
    auth: {
        ...
        getMobileHandoffRoute(source) {
            return graphqlWithKey.post("/graphql", {
                query: `{
                    marketingV1GetMobileHandoffRoute(source: "${source}") {
                        target
                    }
                }`
            });
    ...
    orders: {
        ...
        deleteOrderFollower(orderId, employeeNumber) {
            return rest.delete(
                `/v1/deleteOrderFollower/${orderId}/${employeeNumber}`
            );
        }
    },
    notifications: {
    ...
    reports: {
        ...
        fetchOrderStatusCounts(payload) {
            return rest.get(
                `v1/report/orderStatus/${payload.startDate}/${payload.endDate}`
            );
        },
        ...
        fetchMostActiveBranches(payload) {
            return rest.get(
                `v1/report/mostActiveBranches/${payload.startDate}/${payload.endDate}`
            );
        },
